...
<section>
  ...
  <article>
     <fieldset>
      ...
      User ID<input type="text" name="user_id" value="" size="75" />&nbsp;&nbsp;
    ...
    is Billing<input type="radio" name="bill_active" value="true" checked>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            yes
  <input type="radio" name="active" value="false"> No<br><br/>
  is Shiping<input type="radio" name="ship_active" value="true" checked>
            yes
            <input type="radio" name="active" value="false"> No<br><br/>
